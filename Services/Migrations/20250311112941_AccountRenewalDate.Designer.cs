...
namespace CoreNotify.API.Migrations
{
    ...
    [Migration("20250311112941_AccountRenewalDate")]
    partial class AccountRenewalDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Services.Data.Entities.Serilog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("serilog_pkey");

                    b.HasIndex(new[] { "SourceContext" }, "idx_serilog_source_context");

                    b.ToTable("serilog", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Services.Data.Entities.SerilogContinuationMarker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Services.Data.Entities.SerilogContinuationMarker", b =>
                {
                    b.HasOne("Services.Data.Entities.Account", "Account")
                        .WithMany("SerilogContinuationMarkers")
                        .HasForeignKey("AccountId")
            ...
            modelBuilder.Entity("Services.Data.Entities.Account", b =>
                {
                    ...
                    b.Navigation("SerilogContinuationMarkers");
