	...
	{		
		try
		{
			...
			await _mailerSendClient.SendAsync(new MailerSendClient.Message()
			{
				...
				Html = $"<p>Your account has been created with a renewal date of {account.RenewalDate:M/d/yy}. Your API key is: <strong>{account.ApiKey}</strong></p><p>If you did not do this, please ignore. Someone entered your email by mistake.</p>" +
